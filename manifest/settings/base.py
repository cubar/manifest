...
# It is necesary to add all of these blocks in a list if you want to add your
# own custom one as described in github issue:
# https://github.com/coderedcorp/coderedcms/issues/530
